...
struct Metric_
{
  ...
  _type_type type;
  using _labels_type =
    std::vector<cartographer_ros_msgs::msg::MetricLabel_<ContainerAllocator>, typename ContainerAllocator::template rebind<cartographer_ros_msgs::msg::MetricLabel_<ContainerAllocator>>::other>;
  _labels_type labels;
  using _value_type =
    double;
  _value_type value;
  using _counts_by_bucket_type =
    std::vector<cartographer_ros_msgs::msg::HistogramBucket_<ContainerAllocator>, typename ContainerAllocator::template rebind<cartographer_ros_msgs::msg::HistogramBucket_<ContainerAllocator>>::other>;
  ...
  Type & set__labels(
    const std::vector<cartographer_ros_msgs::msg::MetricLabel_<ContainerAllocator>, typename ContainerAllocator::template rebind<cartographer_ros_msgs::msg::MetricLabel_<ContainerAllocator>>::other> & _arg)
  {
    this->labels = _arg;
    return *this;
  }
  ...
  Type & set__counts_by_bucket(
    const std::vector<cartographer_ros_msgs::msg::HistogramBucket_<ContainerAllocator>, typename ContainerAllocator::template rebind<cartographer_ros_msgs::msg::HistogramBucket_<ContainerAllocator>>::other> & _arg)
  {
