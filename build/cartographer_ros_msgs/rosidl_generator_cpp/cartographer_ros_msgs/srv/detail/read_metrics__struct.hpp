...
struct ReadMetrics_Response_
{
  ...
  using _metric_families_type =
    std::vector<cartographer_ros_msgs::msg::MetricFamily_<ContainerAllocator>, typename ContainerAllocator::template rebind<cartographer_ros_msgs::msg::MetricFamily_<ContainerAllocator>>::other>;
  ...
  Type & set__metric_families(
    const std::vector<cartographer_ros_msgs::msg::MetricFamily_<ContainerAllocator>, typename ContainerAllocator::template rebind<cartographer_ros_msgs::msg::MetricFamily_<ContainerAllocator>>::other> & _arg)
  {
