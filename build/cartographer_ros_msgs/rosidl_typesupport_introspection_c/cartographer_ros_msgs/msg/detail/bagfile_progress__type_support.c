...
void BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_init_function(
...
void BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_fini_function(void * message_memory)
{
  cartographer_ros_msgs__msg__BagfileProgress__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_message_member_array[7] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_message_members = {
  ...
  BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_message_member_array,  // message members
  BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_init_function,  // function to initialize message memory (memory has to be allocated)
  BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_message_type_support_handle = {
  0,
  &BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, msg, BagfileProgress)() {
  if (!BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_message_type_support_handle.typesupport_identifier) {
    BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &BagfileProgress__rosidl_typesupport_introspection_c__BagfileProgress_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
