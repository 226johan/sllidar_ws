...
size_t LandmarkList__rosidl_typesupport_introspection_c__size_function__LandmarkEntry__landmarks(
...
const void * LandmarkList__rosidl_typesupport_introspection_c__get_const_function__LandmarkEntry__landmarks(
...
void * LandmarkList__rosidl_typesupport_introspection_c__get_function__LandmarkEntry__landmarks(
...
bool LandmarkList__rosidl_typesupport_introspection_c__resize_function__LandmarkEntry__landmarks(
...
static rosidl_typesupport_introspection_c__MessageMember LandmarkList__rosidl_typesupport_introspection_c__LandmarkList_message_member_array[2] = {
  ...
  },
  {
    ...
    NULL,  // default value
    LandmarkList__rosidl_typesupport_introspection_c__size_function__LandmarkEntry__landmarks,  // size() function pointer
    LandmarkList__rosidl_typesupport_introspection_c__get_const_function__LandmarkEntry__landmarks,  // get_const(index) function pointer
    LandmarkList__rosidl_typesupport_introspection_c__get_function__LandmarkEntry__landmarks,  // get(index) function pointer
    LandmarkList__rosidl_typesupport_introspection_c__resize_function__LandmarkEntry__landmarks  // resize(index) function pointer
  }
};
