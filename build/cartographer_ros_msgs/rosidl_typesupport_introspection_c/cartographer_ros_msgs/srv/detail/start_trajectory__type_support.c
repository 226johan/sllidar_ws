...
static rosidl_typesupport_introspection_c__MessageMember StartTrajectory_Request__rosidl_typesupport_introspection_c__StartTrajectory_Request_message_member_array[5] = {
  {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, StartTrajectory_Request)() {
  StartTrajectory_Request__rosidl_typesupport_introspection_c__StartTrajectory_Request_message_member_array[3].members_ =
